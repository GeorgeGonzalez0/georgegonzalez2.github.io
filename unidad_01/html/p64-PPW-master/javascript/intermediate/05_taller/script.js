...
const imprimir_objecto = (Objecto) => console.log( `${objecto.nombre} - ${objecto.modelo}, valor: $ ${objeto.costo} `)


//for (let elemento of articulos) {
//    imprimir_objecto( elemento )
//
//}

//articulos.forEach( (objecto) => imprimir_objecto(objecto) )

articulos.forEach( (objeto) => objecto.costo = objeto.costo + 100 )
articulos.forEach( (objeto) => imprimir_objecto(objeto) )
